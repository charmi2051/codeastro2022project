...
class RotationalSpectra:
    ...
    def __init__(self, T, A, B, Jmax = 30, Kmax = 5):
        ...
        Initializes the Rotational Spectra Class, Runs on call

        Args:
            T (float): Temperature of medium 
            A (float): Rotational constant, A
            B (float): Rotational constant, B
            Jmax (int): maximum value of J, quantum number
            Kmax (int): maximum value of K, quantum number
